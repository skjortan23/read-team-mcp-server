    ...
    def _register_handlers(self) -> None:
        ...
        async def handle_call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent | ImageContent | EmbeddedResource]:
            ...
            try:
                ...
                if name == "port_scan":
                    return await self._handle_port_scan(arguments)
                elif name == "scan_status":
                    return await self._handle_scan_status(arguments)
                elif name == "list_scans":
                    return await self._handle_list_scans(arguments)
                elif name == "cancel_scan":
                    return await self._handle_cancel_scan(arguments)
                elif name == "validate_masscan":
                    return await self._handle_validate_masscan(arguments)
                else:
                    return [TextContent(
                        type="text",
